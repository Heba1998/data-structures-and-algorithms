...
const addValues = (arr) => {
const array = arr.reduce((sum , value) => {
  sum += value ;
  return sum;
...
const returnNames = (arr) => {
  let Array = arr.reduce((result, value, index) => {
...
const reversedString = (str) => {
  return str.split('').reduce((result, value) => value + result);
};
/* ------------------------------------------------------------------------------------------------
...
const countNumberOfChildren = (arr) => {
  const array = arr.reduce((sum , characters) => {
    sum += characters.children.length ;
    return sum;
